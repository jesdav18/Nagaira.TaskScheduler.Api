...
{
    public class TaskConfigSqlDto
    {
        [Required(ErrorMessage = "Debes ingresar el tipo de Job, Http = 1 | SQL = 2"), Range(1, 2)]
        public JobExecuterType JobType { get; set; }
        public string? Cron { get; set; }
        public string? TimeZone => Environment.GetEnvironmentVariable("TZ");
        [Required(ErrorMessage = "El PrefixTask puede ser el nombre de la unidad o departamento y es requerido.")]
